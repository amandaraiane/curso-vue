		...
		<div class="conteudo">
			<form class="painel" v-if="exibir">
				...
				<Rotulo nome="Armazenar Dados?">
					<span class="mr-4"><input type="radio" value="Sim" v-model="armazenamento"/>Sim</span>
					<span class="mr-4"><input type="radio" value="Não" v-model="armazenamento"/>Não</span>
				</Rotulo>
				<hr/>
